...
export default function Sidebar({
	...
	return (
		<>
			...
			{/* Mobile Sidebar */}
			<aside
				className={`fixed inset-0 z-510 md:hidden transition-opacity duration-300 ${
					mobileMenuOpen
			...
			>
				...
				/>
				<div
					className={`absolute left-0 top-0 w-64 h-full max-h-screen overflow-y-auto bg-card border-r border-border p-6 flex flex-col z-40 transform transition-transform duration-300 ${
